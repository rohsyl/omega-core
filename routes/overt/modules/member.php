...
use rohsyl\OmegaCore\Http\Controllers\Overt\Modules\Member\Profile\AvatarController;
...
Route::prefix('/member')->group(function() {
    ...
    Route::group(['middleware' => ['auth_member']], function() {
        ...
        Route::get('/profile/avatar', [AvatarController::class, 'edit'])->name('overt.module.member.profile.avatar');
        Route::put('/profile/avatar', [AvatarController::class, 'update'])->name('overt.module.member.profile.avatar.update');
