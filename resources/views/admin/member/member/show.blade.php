...
@section('actions')
    ...
    {{ Form::odelete(route('omega.admin.member.members.destroy', $member), ['class' => 'btn btn-outline-danger btn-sm', 'label' => __('Delete member')]) }}
@endsection


@section('content')

    <x-oix-card title="{{ __('Member') }}" subtitle="{{ __('Member informations.') }}">
    ...
    <x-oix-card title="{{ __('Permissions') }}" subtitle="{{ __('Member permissions.') }}">
