    ...
    <div class="card text-center">
        <div class="card-header">
            ...
            <ul class="nav nav-tabs card-header-tabs" id="users-mgmt-tabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="users-mgmt-roles-tab" data-toggle="tab" data-target="#users-mgmt-roles" type="button" role="tab" aria-controls="users-mgmt-roles" aria-selected="true">Roles</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="users-mgmt-permissions-tab" data-toggle="tab" data-target="#users-mgmt-permissions" type="button" role="tab" aria-controls="users-mgmt-permissions" aria-selected="true">Permissions</button>
                </li>
            </ul>
